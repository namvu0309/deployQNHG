...
import { experienceData, jobType } from "@common/admin/data";
...
const JobFilter = ({ jobData, setJobGrid }) => {
  ...
  const handleSearch = (ele) => {
    ...
    if (search) {
      setJobGrid(
        jobData?.filter((data) => data.title.toLowerCase()?.includes(search))
      );
    } else {
      setJobGrid(jobData);
    }
  ...
  const handleSearchLocation = (ele) => {
    ...
    if (search) {
      setJobGrid(
        jobData?.filter((data) => data.location.toLowerCase()?.includes(search))
      );
    } else {
      setJobGrid(jobData);
    }
