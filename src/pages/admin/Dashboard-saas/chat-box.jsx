...
import { chatData } from "@common/admin/data";
...
const ChantBox = () => {
  ...
  const scrollToBottom = useCallback(() => {
    if (messageBox) {
      messageBox.current.getScrollElement().scrollTop =
        messageBox.current.getScrollElement().scrollHeight;
    }
  }, [messageBox]);
  ...
  const handleDeleteData = (id) => {
    setMessages(
      messages.filter((data) => data.id.toString() !== id.toString())
    );
  };
