...
import img2 from "@assets/admin/images/product/img-2.png";
import img3 from "@assets/admin/images/product/img-3.png";
import img4 from "@assets/admin/images/product/img-4.png";
import img5 from "@assets/admin/images/product/img-5.png";
import img6 from "@assets/admin/images/product/img-6.png";
                            ...
                            <tr key={product.id}>
                              ...
                              <td>
                                <Link
                                  to="#"
                                  onClick={(event) =>
                                    removeCartItem(product.id, event)
                                  }
